...
public class AttentionConfiguration : IEntityTypeConfiguration<Attention>
{
    public void Configure(EntityTypeBuilder<Attention> builder)
    {
        ...
        // builder.Property(e => e.RegistrarCode).HasMaxLength(50).IsRequired();
        ...
        builder
            .Property(e => e.PrePregnancyWeight)
            .HasPrecision(5, 2);
        ...
        // // System & Audit
        // builder.Property(e => e.OriginApplicationCode).HasMaxLength(50);
