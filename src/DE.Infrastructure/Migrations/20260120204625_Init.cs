...
namespace DE.Infrastructure.Migrations
{
    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthServiceUnitCode = table.Column<int>(type: "int", nullable: false),
                    ...
                    RegistrarCode = table.Column<int>(type: "int", nullable: false),
                    FinancierCode = table.Column<int>(type: "int", nullable: false),
                    EstablishmentConditionCode = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
                    ServiceConditionCode = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
                    ...
                    LabValue = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CorrelativeId = table.Column<int>(type: "int", nullable: false),
                    LabCorrelativeId = table.Column<int>(type: "int", nullable: false),
                    ...
                    Hemoglobin = table.Column<decimal>(
                        type: "decimal(4,2)",
                        precision: 4,
                        scale: 2,
                        nullable: true
                    ),
                    AbdominalCircumference = table.Column<decimal>(
                        type: "decimal(5,2)",
                        precision: 5,
                        scale: 2,
                        nullable: true
                    ),
                    HeadCircumference = table.Column<decimal>(
                        type: "decimal(5,2)",
                        precision: 5,
                        scale: 2,
                        nullable: true
                    ),
                    OtherConditionCode = table.Column<int>(type: "int", nullable: true),
                    SettlementCode = table.Column<int>(type: "int", nullable: true),
                    ...
                    RiskGroupDescription = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    PregnancyCondition = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    PrePregnancyWeight = table.Column<decimal>(
                        type: "decimal(5,2)",
                        precision: 5,
                        scale: 2,
                        nullable: true
                    ...
                    Renipress = table.Column<int>(type: "int", nullable: false),
                    EducationalInstitutionCode = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
                    OriginApplicationCode = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MedicalRecordNumber = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: false
                    ),
                    FamilyFolderNumber = table.Column<string>(
                        type: "nvarchar(max)",
                        nullable: true
                    ),
        ...
        {
            migrationBuilder.DropTable(name: "Attentions");
